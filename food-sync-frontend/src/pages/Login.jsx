        ...
        <div className="form-container sign-in">
          {!forgotPassword ? (
            <form onSubmit={handleLogin}>
              <h1>Log In</h1>
              {error && <p style={{color:'#ffcdd2', fontSize:'0.8rem', margin:'4px 0'}}>{error}</p>}
              ...
              <p className="switch-text">
                New to Food Sync? <span onClick={() => setIsRegister(true)}>Create Account</span>
              </p>
            </form>
          ) : (
            /* 🔁 RESET PASSWORD UI (Simplified) */
            <form>
        ...
        <div className="overlay-container">
          <div className="overlay">
            <div className="overlay-panel overlay-left">
              <h1>Welcome Back!</h1>
              <p>Login to manage your food inventory & recipes 🍲</p>
              <button className="ghost" onClick={() => setIsRegister(false)}>Sign In</button>
            </div>
            <div className="overlay-panel overlay-right">
              <h1>Hello, Foodie!</h1>
              <p>Join Food Sync & reduce food waste smartly</p>
